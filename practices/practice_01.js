...
console.log((num1 * 5) + (num2 * 4) + (num3 * 3) + (num4 * 2) + (num5 * 1));
...
let number2 = Math.floor(Math.random() * 25) + 26;
let number3 = Math.floor(Math.random() * 25) + 51;
let number4 = Math.floor(Math.random() * 25) + 76;

console.log(number1, number2, number3, number4);

let maxNumber = Math.max(number1, number2, number3, number4,);
let minNumber = Math.min(number1, number2, number3, number4,);

let diff_max_min = maxNumber - minNumber
let diff_three_four = Math.abs(number2 - number3);
let average = (number1 + number2 + number3 + number4) / 4;

console.log("Difference of max and min = " + diff_max_min);
console.log("Difference of second and third = " + diff_three_four);
