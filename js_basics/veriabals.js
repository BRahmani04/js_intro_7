...
console.log("My name is " + fname); //  concatenation helps to bring multiple tasks together
console.log('I am ' + age); // Age is 25
...
//  LET (you can change it )
// CONST (you cant change it )
